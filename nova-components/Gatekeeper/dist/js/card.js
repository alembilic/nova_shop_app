...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.component('gatekeeper', __webpack_require__(2));
});
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "w-full p-4" }, [
        _c(
          "div",
          { staticClass: "text-90 font-normal text-2xl p-4 text-center" },
          [_vm._v("\n      " + _vm._s(_vm.card.title) + "\n    ")]
        ),
        _vm._v(" "),
        _c("div", [
          _c("div", { staticClass: "inline float-left my-input" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.least_no_of_orders,
                  expression: "least_no_of_orders"
                }
              ],
              staticClass:
                "w-full form-control form-input form-input-bordered inline",
              attrs: {
              ...
              domProps: { value: _vm.least_no_of_orders },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.least_no_of_orders = $event.target.value
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "inline float-left my-input" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.popular_products_on_order,
                  expression: "popular_products_on_order"
                }
              ],
              staticClass:
                "w-full form-control form-input form-input-bordered inline",
              ...
              domProps: { value: _vm.popular_products_on_order },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.popular_products_on_order = $event.target.value
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "inline float-left my-input" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.sku_in_order_no,
                  expression: "sku_in_order_no"
                }
              ],
              staticClass:
                "w-full form-control form-input form-input-bordered inline",
              ...
              domProps: { value: _vm.sku_in_order_no },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.sku_in_order_no = $event.target.value
                }
              }
            })
          ]),
          ...
          _c(
            "div",
            { staticClass: "inline float-left my-select" },
            [
              _c(
                "multiselect",
                {
                  ...
                  model: {
                    value: _vm.selectedSku,
                    callback: function($$v) {
                      _vm.selectedSku = $$v
                    },
                    expression: "selectedSku"
                  }
                },
                [
                  _c(
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("ead349a2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9bc2c0a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./Card.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b9bc2c0a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./Card.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.form-control[data-v-b9bc2c0a] {\r\n  height: 40px;\n}\n.my-select[data-v-b9bc2c0a] {\r\n  width: 30%;\n}\n.my-input[data-v-b9bc2c0a] {\r\n  width: 20%;\n}\n.float-left[data-v-b9bc2c0a] {\r\n  margin-left: 5px;\n}\n.btn-primary[data-v-b9bc2c0a] {\r\n  margin-left: 5px;\n}\r\n", ""]);
